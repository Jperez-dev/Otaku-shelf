// Vercel serverless function to proxy MangaDX statistics API requests with ID parameter
export default async function handler(req, res) {
  ...
  try {
    ...
    const mangaDxUrl = `https://api.mangadex.org/statistics/manga/${id}${queryString ? '?' + queryString : ''}`;

    console.log('Proxying statistics detail request to:', mangaDxUrl);
    ...
    console.error('Statistics detail API proxy error:', error);
